...
do
    ...
    if [ $instance != "frontend" ]; then
         IP=$(aws ec2 describe-instances --instance-ids i-0272eb5087250ccf6 --query 'Reservations[0].Instances[0].PrivateIpAddress' --output text)
    else
        IP=$(aws ec2 describe-instances --instance-ids i-0272eb5087250ccf6 --query 'Reservations[0].Instances[0].PublicIpAddress' --output text)
    fi
